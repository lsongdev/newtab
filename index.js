...
const tuweiqinghua = () => {
  return Promise
    .resolve()
    .then(() => fetch(`data/tuweiqinghua.txt`))
    .then(res => res.text())
    .then(res => res.split(/\n/g))
};
    ...
    ...words.map((sentence, id) => {
      return {
        ...
        source: {
          id,
          title: '土味情话',
          link: 'https://github.com/lsongdev/newtab/blob/master/data/tuweiqinghua.txt'
        }
      };
    }),
    ...jitang.map((sentence, id) => {
      return {
        ...
        source: {
          id,
          title: 'dujitang',
          link: 'https://github.com/lsongdev/newtab/blob/master/data/dujitang.txt'
        }
      };
    }),
  ]);
